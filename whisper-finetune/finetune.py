...
add_arg("train_data",    type=str, default="/root/autodl-tmp/dataset/train.json",       help="训练数据集的路径")
add_arg("test_data",     type=str, default="/root/autodl-tmp/dataset/test.json",        help="测试数据集的路径")
add_arg("base_model",    type=str, default="/root/autodl-tmp/whisper-large",      help="Whisper的基础模型")
add_arg("output_dir",    type=str, default="/root/autodl-tmp/output/",                  help="训练保存模型的路径")
...
add_arg("num_train_epochs", type=int, default=2,      help="训练的轮数")
