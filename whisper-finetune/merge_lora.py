...
add_arg("lora_model", type=str, default="/root/autodl-tmp/output/whisper-tiny/checkpoint-best/", help="微调保存的模型路径")
add_arg('output_dir', type=str, default='/root/autodl-tmp/models/',    help="合并模型的保存目录")
