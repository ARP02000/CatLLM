...
add_arg("test_data",   type=str, default="/root/autodl-tmp/dataset/test.json",            help="测试集的路径")
add_arg("model_path",  type=str, default="/root/autodl-tmp/whisper-finetune", help="合并模型的路径")
