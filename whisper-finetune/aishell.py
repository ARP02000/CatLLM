...
add_arg("filepath", default='/root/autodl-tmp/data_aishell.tgz', type=str, help="压缩包data_aishell.tgz文件路径，不指定会自动下载")
add_arg("target_dir", default="/root/autodl-tmp/dataset/audio/", type=str, help="存放音频文件的目录")
add_arg("annotation_text", default="/root/autodl-tmp/dataset/", type=str, help="存放音频标注文件的目录")
